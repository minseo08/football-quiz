    ...
    <main className="h-screen bg-gray-950 text-white pt-24 p-8 flex flex-col">
      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col flex-1 overflow-hidden">
        <div className="flex-none">
          ...
          <p className="text-gray-500 mb-8 font-bold">도전할 퀴즈 유형을 선택하세요</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar pb-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
            ...
            >
              <div className="mode-icon mb-6"><img src="/logo.png" alt="아이콘" width="70" /></div>
            ...
            <button 
              ...
              className="bg-gray-900 p-10 rounded-[2rem] border border-gray-800 hover:border-green-500 transition-all group shadow-xl flex flex-col items-center text-center"
            >
              <div className="mode-icon mb-6"><img src="/player.png" alt="아이콘" width="70" /></div>
            ...
            <button 
              ...
              className="bg-gray-900 p-10 rounded-[2rem] border border-gray-800 hover:border-green-500 transition-all group shadow-xl flex flex-col items-center text-center"
            >
              <div className="mode-icon mb-6"><img src="/stadium.png" alt="아이콘" width="70" /></div>
            ...
            <button 
              ...
              className="bg-gray-900 p-10 rounded-[2rem] border border-gray-800 hover:border-green-500 transition-all group shadow-xl flex flex-col items-center text-center"
            >
              <div className="mode-icon mb-6"><img src="/nationality.png" alt="아이콘" width="70" /></div>
            ...
            <button 
              ...
              className="bg-gray-900 p-10 rounded-[2rem] border border-gray-800 hover:border-green-500 transition-all group shadow-xl flex flex-col items-center text-center"
            >
              <div className="mode-icon mb-6"><img src="/career.png" alt="아이콘" width="70" /></div>
            ...
            <button 
              ...
              className="bg-gray-900 p-10 rounded-[2rem] border border-gray-800 hover:border-green-500 transition-all group shadow-xl flex flex-col items-center text-center"
            >
              <div className="mode-icon mb-6"><img src="/squad_nation.png" alt="아이콘" width="60" /></div>
            ...
            <button 
              ...
              className="bg-gray-900 p-10 rounded-[2rem] border border-gray-800 hover:border-green-500 transition-all group shadow-xl flex flex-col items-center text-center"
            >
              <div className="mode-icon mb-6"><img src="/coach.png" alt="아이콘" width="60" /></div>
