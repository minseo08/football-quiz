    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 p-10 rounded-[2.5rem] shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <button 
          ...
          className="mt-6 w-full text-gray-400 text-sm font-bold border-1 border-gray-500 hover:text-white transition py-2 bg-gray-800/50 hover:border-green-500 rounded-xl"
        >
          비회원으로 이용
        </button>
